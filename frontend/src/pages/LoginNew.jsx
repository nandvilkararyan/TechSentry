...
import { Eye, EyeOff, Shield, AlertCircle, User, Lock, Mail } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">TechSentry</h1>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex justify-center items-center py-2.5 px-4 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 bg-white/50 backdrop-blur-sm hover:bg-gray-50 transition-all duration-200">
